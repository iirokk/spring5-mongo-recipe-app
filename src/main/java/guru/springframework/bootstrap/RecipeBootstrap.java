...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.warn("Categories: " + categoryReactiveRepository.count().block());
        log.warn("Units: " + unitOfMeasureReactiveRepository.count().block());
        log.warn("Recipes: " + recipeReactiveRepository.count().block());
    }
